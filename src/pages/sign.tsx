      ...
      <Card className="w-full max-w-md">
            ...
            <div className="space-y-2">
              <div className="relative">
                ...
                <input
                  ...
                  } py-3 pl-12 pr-4 text-sm outline-none focus:border-teal-600 focus:ring-1 focus:ring-teal-600`}
                  type="email"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="remember"
                  className="h-4 w-4 rounded border-gray-200 text-teal-600 focus:ring-teal-600"
                />
                <label
                  htmlFor="remember"
        ...
        <CardFooter>
          <p className="text-center text-sm text-gray-600 w-full">
            ...
            <button className="text-teal-600 hover:text-teal-500 font-semibold">
              Sign up
            </button>
          </p>
        </CardFooter>
