...
//           {' '}
//           Dive into the{' '}
//           <span className="block text-blue-500">World of Robotics</span> With
//           Us!{' '}
//         </h1>
//         <Carousel
//           slides={slides}
...
// Previous interfaces and Carousel component remain the same
interface SlideType {
  id: number;
  imageUrl: string;
  title: string;
...
export default function HeroSection() {
  ...
  return (
    <div className="p-6 bg-gray-800 my-6 rounded-lg mx-8 ">
